...
describe('ecEncrypt', function () {
  ...
  context.only('#ecEncrypt', function () {
    it('should call crypto.createCipheriv and transform cipher', function () {
      ...
      _ecEncrypt2.default.ecEncrypt(key, iv, string);

      _chai.assert.deepEqual(_crypto2.default.createCipheriv.args[0], ['aes-256-gcm', key, iv], 'crypto.createCipheriv should have been called with key, iv, and string');
    });
  });
